...
// import 'package:isalescrm/sip_account/SipDialPad.dart';
...
//     return Scaffold(
//         body: Container(decoration: const BoxDecoration(gradient: LinearGradient(colors: [dialPad1, dialPad2], begin: Alignment.bottomLeft, end: Alignment.topRight,)), child: Padding(
//         padding: const EdgeInsets.fromLTRB(0, 60, 0, 50),
//         child: ListView(
//           children: [
//             //Call Status
//             Text(callStatus, textAlign: TextAlign.center,style: TextStyle(color: callStatus.contains("Forbidden")?Colors.redAccent:Colors.white, fontSize: 16),),
//
//             //Recipient name
//             Padding(
...
//                       ),
//
//                       isRecording? buildCallRecordTImer()
//                           : const Text("Record", style: TextStyle(color: Colors.grey),
//                       )
//                     ],
//                   ),
//                 ],
...
//                         },
//                       ),
//                       const Text("Speaker", style: TextStyle(color: Colors.grey),
//                       )
//                     ],
//                   ),
//                 ],
...
//
//         //make a call
//         Voip24hSdkMobile.callModule.call("5$phoneNumber");
...
//           "name":widget.callerName.contains("Unknown") ? widget.phoneNumber : widget.callerName ,
//         }
//     );
//   }
//
...
//
//     String date = "${numberFormat(today.day)}/${numberFormat(today.month)}/${numberFormat(today.year)}";
...
//     try{
//       await overlayChannel.invokeMethod("overlayPopUp",{"phoneNumber": widget.phoneNumber,"callerName":widget.callerName});
//     }catch(e){
