...
import 'package:untitled1/Lead/lead_dailpad.dart';
...
class LeadCallui extends StatefulWidget {
  const LeadCallui({super.key, required this.phoneNumber, required this.callerName});
  final String phoneNumber;
  final String callerName;
  @override
  State<LeadCallui> createState() => _LeadCalluiState();
}

class _LeadCalluiState extends State<LeadCallui> {
          ...
          case SipEvent.Hangup:
            ...
            if (!isCallHangUp) {
              ...
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const LeadDailpad()));
            }
